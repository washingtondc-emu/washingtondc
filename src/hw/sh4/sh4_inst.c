...
static struct InstOpcode opcode_list[] = {
    ...
    // SHAL Rn
    { &sh4_inst_unary_shal_gen, sh4_disas_fallback, false,
      SH4_GROUP_EX, 1, 0xf0ff, 0x4020 },

    // SHAR Rn
    { &sh4_inst_unary_shar_gen, sh4_disas_fallback, false,
      SH4_GROUP_EX, 1, 0xf0ff, 0x4021 },

    // SHLL Rn
    { &sh4_inst_unary_shll_gen, sh4_disas_fallback, false,
    ...
    // SHLR2 Rn
    { &sh4_inst_unary_shlr2_gen, sh4_disas_fallback, false,
    ...
    // SHLR16 Rn
    { &sh4_inst_unary_shlr16_gen, sh4_disas_fallback, false,
    ...
    // CMP/HI Rm, Rn
    { &sh4_inst_binary_cmphi_gen_gen, sh4_disas_fallback, false,
