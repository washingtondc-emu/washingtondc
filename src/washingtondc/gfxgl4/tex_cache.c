...
static struct gfxgl4_tex tex_cache[GFX_TEX_CACHE_SIZE];
...
void gfxgl4_tex_cache_bind(unsigned tex_no, int obj_no, unsigned width,
    ...
    struct gfxgl4_tex *tex = tex_cache + tex_no;
    ...
    gfxgl4_renderer_update_tex(tex_no);
}

void gfxgl4_tex_cache_unbind(unsigned tex_no) {
    gfxgl4_tex_cache_evict(tex_no);
}
...
static void update_tex_from_obj(struct gfx_obj *obj,
    ...
    struct gfxgl4_tex *tex = (struct gfxgl4_tex*)obj->arg;
    gfxgl4_renderer_update_tex(tex - tex_cache);
}
